...
with open(file_to_save, "w") as txt_file:
    ...
    for county_names in county_votes:
        ...
        county_results = (
            f"{county_names}: {percentage_votes:.1f}% ({votes:,})\n")
        ...
        if (votes > largest_county_count) and (percentage_votes > largest_county_percentage):
            largest_county_count = votes
            largest_county = county_names
            largest_county_percentage = percentage_votes

    # 7: Print the county with the largest turnout to the terminal.
    # Other method to find largest county turnout
